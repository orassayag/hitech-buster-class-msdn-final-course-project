...
public partial class _55DeadMovies : System.Web.UI.Page
{
    ...
    protected void resultBut_Click(object sender, EventArgs e)
    {
        ...
        this.deadMoviesGrid.DataSource = this.Master.VideoDB.DeadMoviesReport(date);
        this.deadMoviesGrid.DataBind();
